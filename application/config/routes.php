...
// Added by me
$route['tentang-kami'] = 'home_controller/about';
$route['produk'] = 'home_controller/produk';
$route['layanan'] = 'home_controller/layanan';
$route['mitra-kerja'] = 'home_controller/mitrakerja';
$route['sambutan'] = 'home_controller/sambutan';
$route['visi-misi'] = 'home_controller/visimisi';
$route['jajaran-komisaris'] = 'home_controller/jajarankomisaris';
$route['jajaran-direksi'] = 'home_controller/jajarandireksi';
$route['legalitas'] = 'home_controller/legalitas';
...
foreach ($languages as $language) {
    if ($language->status == 1 && $general_settings->site_lang != $language->id) {
        ...
        // Added by me
        $route[$key . '/tentang-kami'] = 'home_controller/about';
        $route[$key . '/produk'] = 'home_controller/produk';
        $route[$key . '/layanan'] = 'home_controller/layanan';
        $route[$key . '/mitra-kerja'] = 'home_controller/mitrakerja';
        $route[$key . '/sambutan'] = 'home_controller/sambutan';
        $route[$key . '/visi-misi'] = 'home_controller/visimisi';
        $route[$key . '/jajaran-komisaris'] = 'home_controller/jajarankomisaris';
        $route[$key . '/jajaran-direksi'] = 'home_controller/jajarandireksi';
        $route[$key . '/legalitas'] = 'home_controller/legalitas';
