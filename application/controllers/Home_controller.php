...
class Home_controller extends Home_Core_Controller
{
    ...
    public function post($slug)
    {
        ...
        if (empty($data['post'])) {
            ...
            $this->load->view('partials/_header_post', $data);
    ...
    {
        $data['page'] = $this->page_model->get_page_by_lang('tentang-kami', $this->selected_lang->id);
        //check page auth
        $this->checkPageAuth($data['page']);
    ...
    {
        $data['page'] = $this->page_model->get_page_by_lang('produk', $this->selected_lang->id);
        //check page auth
        $this->checkPageAuth($data['page']);
    ...
    {
        $data['page'] = $this->page_model->get_page_by_lang('layanan', $this->selected_lang->id);
        //check page auth
        $this->checkPageAuth($data['page']);
    ...
    {
        $data['page'] = $this->page_model->get_page_by_lang('mitra-kerja', $this->selected_lang->id);
        //check page auth
        $this->checkPageAuth($data['page']);
        ...
        if ($data['page']->visibility == 0) {
            ...
            $this->load->view('partials/_header', $data);
            $this->load->view('mitra-kerja', $data);
            $this->load->view('partials/_footer');
        }
     ...
     */
     ...
     {
         $data['page'] = $this->page_model->get_page_by_lang('sambutan', $this->selected_lang->id);
         //check page auth
         $this->checkPageAuth($data['page']);
     ...
     */
     ...
     {
         $data['page'] = $this->page_model->get_page_by_lang('visi-misi', $this->selected_lang->id);
         //check page auth
         $this->checkPageAuth($data['page']);
     ...
     * Jajaran Komisaris
     */
     public function jajarankomisaris()
     {
         $data['page'] = $this->page_model->get_page_by_lang('jajaran-komisaris', $this->selected_lang->id);
         //check page auth
         $this->checkPageAuth($data['page']);
         ...
         if ($data['page']->visibility == 0) {
             ...
             $this->load->view('partials/_header', $data);
             $this->load->view('jajaran-komisaris', $data);
             $this->load->view('partials/_footer');
         }
     ...
     * Jajaran Direksi
     */
     public function jajarandireksi()
     {
         $data['page'] = $this->page_model->get_page_by_lang('jajaran-direksi', $this->selected_lang->id);
         //check page auth
         $this->checkPageAuth($data['page']);
         ...
         if ($data['page']->visibility == 0) {
             ...
             $this->load->view('partials/_header', $data);
             $this->load->view('jajaran-direksi', $data);
             $this->load->view('partials/_footer');
         }
     ...
     */
     ...
     {
         $data['page'] = $this->page_model->get_page_by_lang('legalitas', $this->selected_lang->id);
         //check page auth
         $this->checkPageAuth($data['page']);
    ...
    public function error_404()
    {
        ...
        $data['keywords'] = "error,404,page not found";
